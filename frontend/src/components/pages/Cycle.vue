<template>
    <div>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <div class="contact_bt"><router-link to="/bikes">Shop Now</router-link></div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="cycle_section layout_padding">
            <div class="container">
                <h1 class="cycle_taital">Our most popular cycles</h1>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box_main">
                                ...
                                <div class="image_2">
                                    <img :src="products[0]?.imgPath || 'images/img-1.png'" alt="Bike 1" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <h1 class="cycles_text">{{ products[0]?.model || 'Cycle' }}</h1>
                            ...
                            <div class="btn_main">
                                ...
                                <h4 class="price_tex">
                                    ...
                                    <span style="color: #325662">{{ products[0]?.price || 220 }}</span>
                                </h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="cycle_section_3 layout_padding">
                    <div class="row">
                        <div class="col-md-6">
                            <h1 class="cycles_text">{{ products[1]?.model || 'Stylish' }}</h1>
                            <p class="lorem_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters.</p>
                            <div class="btn_main">
                                <div class="buy_btn"><router-link to="/bikes">Order</router-link></div>
                                <h4 class="price_tex">
                                    Price <span style="color: #f7c17b">$</span> 
                                    <span style="color: #325662">{{ products[1]?.price || 280 }}</span>
                                </h4>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="box_main_3">
                                ...
                                <div class="image_2">
                                    <img :src="products[1]?.imgPath || 'images/img-2.png'" alt="Bike 2" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="box_main_3">
                                ...
                                <div class="image_2">
                                    <img :src="products[2]?.imgPath || 'images/img-3.png'" alt="Bike 3" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <h1 class="cycles_text">{{ products[2]?.model || 'Modern' }}</h1>
                            <p class="lorem_text">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters.</p>
                            <div class="btn_main">
                                <div class="buy_btn"><router-link to="/bikes">Order</router-link></div>
                                <h4 class="price_tex">
                                    Price <span style="color: #f7c17b">$</span> 
                                    <span style="color: #325662">{{ products[2]?.price || 250 }}</span>
                                </h4>
                            </div>
                        </div>
                    </div>
